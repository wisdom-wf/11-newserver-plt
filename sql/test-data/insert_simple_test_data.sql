...
-- 1. 创建订单（只包含必要字段）
INSERT INTO t_order (order_id, order_no, elder_id, elder_name, elder_phone, elder_address, service_type_code, service_type_name, service_date, service_time, service_duration, service_address, order_type, order_source, status, provider_id, estimated_price, create_time, update_time, deleted) VALUES
('ORDER001', 'ORD20260514001', 'ELDER001', '张大爷', '13900002001', '西安市碑林区长安北路101号', 'HOME_CARE', '居家照料', '2026-05-15', '09:00', 2, '西安市碑林区长安北路101号', 'NORMAL', 'ONLINE', 'CREATED', (SELECT provider_id FROM t_elder WHERE elder_id='ELDER001'), 200.00, NOW(), NOW(), 0),
('ORDER002', 'ORD20260514002', 'ELDER002', '李奶奶', '13900002002', '西安市雁塔区科技路201号', 'HEALTH_MONITOR', '健康管理', '2026-05-15', '14:00', 1, '西安市雁塔区科技路201号', 'NORMAL', 'PHONE', 'CREATED', (SELECT provider_id FROM t_elder WHERE elder_id='ELDER002'), 150.00, NOW(), NOW(), 0),
('ORDER003', 'ORD20260514003', 'ELDER003', '王大爷', '13900002003', '西安市未央区凤城五路301号', 'MEAL_DELIVERY', '助餐服务', '2026-05-15', '11:30', 1, '西安市未央区凤城五路301号', 'NORMAL', 'ONLINE', 'CREATED', (SELECT provider_id FROM t_elder WHERE elder_id='ELDER003'), 50.00, NOW(), NOW(), 0);
