...
CREATE TABLE `appointment` (
  ...
  `appointment_token` varchar(64) DEFAULT NULL COMMENT '预约二维码token',
  `token_status` enum('ACTIVE','DISABLED') DEFAULT 'ACTIVE' COMMENT 'token状态',
  ...
  KEY `idx_appointment_token` (`appointment_token`)
...
CREATE TABLE `quality_check` (
  ...
  `check_photos` mediumtext COMMENT '检查照片',
  ...
  `rectify_photos` mediumtext COMMENT '整改照片',
...
CREATE TABLE `service_log` (
  ...
  `service_photos` mediumtext COMMENT '服务照片',
  ...
  `anomaly_photos` mediumtext COMMENT '异常照片',
  ...
  `sign_in_photos` mediumtext COMMENT '签到照片',
  `sign_out_location` varchar(200) DEFAULT NULL COMMENT '签退位置',
  `sign_out_photos` mediumtext COMMENT '签退照片',
...
CREATE TABLE `t_customer_feedback` (
  ...
  `feedback_attachments` mediumtext COMMENT '反馈附件',
...
CREATE TABLE `t_device` (
  `device_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备ID（UUID）',
  `device_sn` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备序列号（二维码内容）',
  `device_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备类型：BP-血压计/BG-血糖仪/WT-体重秤/TP-体温计/PL-脉搏仪/SP-血氧仪',
  `device_name` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设备名称',
  `manufacturer` varchar(128) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '制造商',
  `model` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '型号',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'INACTIVE' COMMENT '状态：INACTIVE-未激活/ACTIVE-已激活/OFFLINE-离线/FAULT-故障',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_device_binding`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_device_binding` (
  `binding_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '绑定ID',
  `device_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '设备ID',
  `elder_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '客户ID',
  `measurement_type` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '测量类型：BLOOD_PRESSURE/BLOOD_GLUCOSE/WEIGHT/TEMPERATURE/PULSE/SPO2',
  `bind_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '绑定时间',
  `unbind_time` datetime DEFAULT NULL COMMENT '解绑时间',
  `status` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'ACTIVE' COMMENT '状态：ACTIVE-已绑定/UNBOUND-已解绑',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_device_push_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_device_push_log` (
  `push_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '推送ID',
  `device_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '设备ID',
  `binding_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '绑定ID',
  `elder_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '客户ID',
  `raw_data` text COLLATE utf8mb4_unicode_ci COMMENT '原始推送数据（JSON）',
  `measurement_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联的测量记录ID',
  `push_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '推送时间',
  `process_status` varchar(16) COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING' COMMENT '处理状态：PENDING/SUCCESS/FAILED',
...
CREATE TABLE `t_elder_health` (
  ...
  `adl_score` int DEFAULT NULL COMMENT 'ADL评分',
  `mmse_score` int DEFAULT NULL COMMENT 'MMSE评分',
  `gds_score` int DEFAULT NULL COMMENT 'GDS评分',
  `fall_risk` int DEFAULT NULL COMMENT '跌倒风险',
  `pressure_sore_risk` int DEFAULT NULL COMMENT '压疮风险',
  `nutrition_status` int DEFAULT NULL COMMENT '营养状态',
  `vision_status` int DEFAULT NULL COMMENT '视力状态',
  `hearing_status` int DEFAULT NULL COMMENT '听力状态',
  `oral_health` int DEFAULT NULL COMMENT '口腔健康',
  `mobility_status` int DEFAULT NULL COMMENT '行动能力',
  `health_remark` varchar(1000) DEFAULT NULL COMMENT '健康备注',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_ess_contract`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_ess_contract` (
  ...
  `status` varchar(32) NOT NULL COMMENT 'DRAFT/INITIATED/SIGNING/SIGNED/COMPLETED/EXPIRED/REJECTED/CANCELLED',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_health_ai_suggestion`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_health_ai_suggestion` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `elder_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `elder_name` varchar(64) COLLATE utf8mb4_unicode_ci NOT NULL,
  `care_level_suggestion` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `risk_alerts` text COLLATE utf8mb4_unicode_ci,
  `care_suggestions` text COLLATE utf8mb4_unicode_ci,
  `audio_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'AI建议语音URL',
  `care_evaluate_time` datetime DEFAULT NULL,
  `urgency_level` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `urgency_level_name` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `suggested_department` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `medical_suggestions` text COLLATE utf8mb4_unicode_ci,
  `symptoms` text COLLATE utf8mb4_unicode_ci,
  `medical_evaluate_time` datetime DEFAULT NULL,
  `ai_model` varchar(64) COLLATE utf8mb4_unicode_ci DEFAULT 'qwen-plus',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_health_measurement`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_health_measurement` (
  `measurement_id` varchar(32) NOT NULL COMMENT '测量记录ID',
  `elder_id` varchar(32) NOT NULL COMMENT '老人ID',
  `service_log_id` varchar(32) DEFAULT NULL COMMENT '服务日志ID',
  `measurement_type` varchar(32) NOT NULL COMMENT '测量类型',
  `measurement_value` varchar(64) NOT NULL COMMENT '测量值',
  `measurement_unit` varchar(32) DEFAULT NULL COMMENT '单位',
  `measured_at` datetime NOT NULL COMMENT '测量时间',
  `staff_id` varchar(32) DEFAULT NULL COMMENT '测量人员ID',
  `staff_name` varchar(50) DEFAULT NULL COMMENT '测量人员姓名',
...
CREATE TABLE `t_health_report` (
  ...
  `pdf_url` varchar(500) DEFAULT NULL COMMENT 'PDF路径',
  `cover_image_url` varchar(500) DEFAULT NULL COMMENT '封面图片URL',
  `staff_id` varchar(32) DEFAULT NULL COMMENT '生成员工ID',
  `staff_name` varchar(50) DEFAULT NULL COMMENT '生成员工姓名',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  `deleted` tinyint DEFAULT '0',
...
/*!40101 SET character_set_client = @saved_cs_client */;
DROP TABLE IF EXISTS `t_image_recognition_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `t_image_recognition_log` (
  `log_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '日志ID',
  `elder_id` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '关联老人ID',
  `image_type` varchar(32) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片类型',
  `original_filename` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '原始文件名',
  `image_url` varchar(500) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '图片存储URL',
  `recognized_text` text COLLATE utf8mb4_unicode_ci COMMENT 'AI识别的原始文本',
  `recognition_result` text COLLATE utf8mb4_unicode_ci COMMENT '结构化识别结果',
  `ai_model` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT '使用的AI模型',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`log_id`)
...
CREATE TABLE `t_order` (
  ...
  `complete_time` datetime DEFAULT NULL COMMENT '完成服务时间',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
...
CREATE TABLE `t_provider` (
  ...
  `register_address` varchar(1000) DEFAULT NULL,
  `business_address` varchar(1000) DEFAULT NULL,
  `contact_person` varchar(50) DEFAULT NULL COMMENT '联系人',
  `contact_phone` varchar(20) DEFAULT NULL COMMENT '联系电话',
  `address` varchar(1000) DEFAULT NULL,
  `service_category` varchar(20) DEFAULT NULL COMMENT '服务类别',
  ...
  `business_license` mediumtext COMMENT '营业执照',
  `status` varchar(20) DEFAULT 'PENDING' COMMENT '状态 PENDING/APPROVED/REJECTED/SUSPENDED',
  `audit_comment` varchar(1000) DEFAULT NULL COMMENT '审核备注',
...
CREATE TABLE `t_provider_qualification` (
  ...
  `attachment_url` mediumtext COMMENT '资质证书附件',
...
CREATE TABLE `t_service_evaluation` (
  ...
  `environment_score` decimal(5,2) DEFAULT NULL COMMENT '环境评分',
  `professional_score` decimal(5,2) DEFAULT NULL COMMENT 'professional_score',
  `average_score` decimal(5,2) DEFAULT NULL COMMENT '平均得分',
  `evaluation_content` text COMMENT '评价内容',
  `evaluation_images` varchar(2000) DEFAULT NULL COMMENT 'evaluation_images',
...
CREATE TABLE `t_staff` (
  ...
  `service_types` varchar(200) DEFAULT NULL,
