  ...
  <div>
    ...
    <NCard title="订单统计" :bordered="false" style="margin-bottom: 16px">
      <NSpace :size="20" :wrap="true">
        <NStatistic label="总订单数" :value="statistics.total" />
        <NStatistic label="今日订单" :value="statistics.today" />
        <NStatistic label="本月订单" :value="statistics.month" />
        <NStatistic label="完成率" :value="`${statistics.completionRate}%`" />
        <NStatistic label="待分配" :value="statistics.pending" />
        <NStatistic label="已分配" :value="statistics.assigned" />
        <NStatistic label="服务中" :value="statistics.inService" />
